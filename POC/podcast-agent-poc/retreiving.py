...
#         self.dims = len(self.encoder(["test"])[0])  # Get embedding dimensions
...
#     def create_index(self, index_name: str = "pdf-embeddings"):
...
#     def index_document(self, doc_info: Dict[str, Any], batch_size: int = 128):
...
#         if doc_info:
#             num_chunks = processor.index_document(doc_info)
